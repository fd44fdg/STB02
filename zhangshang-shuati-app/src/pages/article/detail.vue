...
<style scoped>
	...
	.article-summary {
		...
		background-color: var(--muted, #f8f9fa);
		border-radius: 12rpx;
		border-left: 6rpx solid var(--accent, #4A90E2);
	}
	...
	.code-header {
		...
		align-items: center;
		padding: 20rpx 25rpx;
		background-color: var(--code-header-bg, #2d3748);
	}
	...
	.code-content {
		padding: 25rpx;
		background-color: var(--code-bg, #1a202c);
		overflow-x: auto;
	}
	...
	.code-description {
		padding: 20rpx 25rpx;
		background-color: var(--muted, #f7fafc);
	...
	.link-item:active {
		background-color: var(--muted-border, #e9ecef);
	...
	.tag-chip {
		padding: 12rpx 20rpx;
		background-color: var(--tag-bg, #f0f8ff);
	...
	.avatar-placeholder {
		...
		height: 70rpx;
		border-radius: 50%;
		background-color: var(--avatar-bg, #4A90E2);
		display: flex;
		align-items: center;
		justify-content: center;
	}
	...
	.replies-list {
		margin-top: 15rpx;
		padding-left: 20rpx;
		border-left: 3rpx solid var(--muted-border, #f0f0f0);
	}
	
	.reply-item {
		display: flex;
		padding: 15rpx 0;
		border-bottom: 1rpx solid var(--muted, #f8f9fa);
	}
	...
	.reply-avatar-placeholder {
		...
		height: 50rpx;
		border-radius: 50%;
		background-color: var(--reply-avatar-bg, #6c757d);
		display: flex;
		align-items: center;
		justify-content: center;
	}
